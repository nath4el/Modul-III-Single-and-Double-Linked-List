...
public:
    ...
    bool ubahproduk140(string Nama_Produk_Lama, string Nama_Produk_Baru, int Harga_Baru)
    ...
    void sisipposisi140(string Nama_Produk, int harga, int posisi)
    { // Menambahkan data produk pada posisi tertentu
        ...
        { // Looping sampai posisi sebelum posisi yang diinginkan (Posisi - 1)
            current = current->next;
        }
        if (current == nullptr)
        {
